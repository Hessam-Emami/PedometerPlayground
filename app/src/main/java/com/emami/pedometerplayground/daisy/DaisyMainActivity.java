package com.emami.pedometerplayground.daisy;
...
public class DaisyMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stepCounter = (int) DaisyDebugActivity.mStepCounter;
        mHandler = new Handler();
        startRepeatingTask();
    }

    private void updateView(){
        if(DaisyDebugActivity.mStepCounter > stepCounter) {
            stepCounter = (int) DaisyDebugActivity.mStepCounter;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_debug) {
            Intent intent = new Intent(context, DaisyDebugActivity.class);
